...
import "./App.css";
import timeHelper from "date-and-time-helpers-abtintime";
...
function App() {
  ...
  return (
    <div className="App">
      ...
      <h1> {timeHelper({ startDate, endDate })} </h1>
      ...
      <div className="tests">
        ...
        <TestLink
          ...
          endDate="2019-11-29"
          expected="10 Nov 2019 - 29 Nov 2019"
          onClick={handleTest}
          color="red"
        />
        <TestLink
...
const RedDay = ({ date, hours, name }) => {
  return (
    <div className="red-day">
      ...
      <div className="red-day-hours p2">
        {hours === 0 ? "Ledigt" : "Halvdag"}
      </div>
    </div>
  );
};
